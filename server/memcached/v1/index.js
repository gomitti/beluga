...
import { delete_desktop_columns_from_cache } from "./desktop/columns/restore"
...
export default {
    status, user, account, hashtag, server, reaction, favorite, media, timeline, access_token, desktop, hashtags, emoji,
    ...
    delete_account_pin_emoji_from_cache, delete_timeline_hashtag_from_cache, delete_timeline_mentions_from_cache,
    ...
    delete_media_from_cache, delete_desktop_columns_from_cache, delete_hashtag_joined_from_cache,

...
export class ColumnStore {
    ...
    restore = (history, settings) => {
        ...
        for (const item of history) {
            ...
            assert(is_object(settings), "@options must be of type object")
    ...
    push = (request_query, params, options, initial_statuses) => {
        ...
        assert(is_object(options), "@options must be of type string")
        assert(is_object(request_query), "@request_query must be of type string")
        assert(is_object(params), "@params must be of type string")

...
export default async (db, params) => {
    ...
    query.belongs_to = try_convert_to_object_id(params.in_reply_to_status_id, "$in_reply_to_status_idが不正です")
    return await db.collection("thread_timeline").find(query).count()
}
...
export default class App extends Component {
    ...
    render() {
        const { platform, community, members, device, logged_in_user } = this.props
        ...
        return (
            <div id="app" className="join-community">
                <Head title={`${community.display_name}に参加する / ${config.site.name}`} platform={platform} device={device} logged_in_user={logged_in_user} />

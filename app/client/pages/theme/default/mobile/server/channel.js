...
export default class App extends Component {
    ...
    render() {
        const { server, logged_in_user, channel, platform, device, pinned_emoji_shortnames, custom_emoji_shortnames } = this.props
        return (
            <div id="app" className="timeline home">
                <Head title={`${channel.name} / ${server.display_name} / ${config.site.name}`} platform={platform} logged_in_user={logged_in_user} device={device} />

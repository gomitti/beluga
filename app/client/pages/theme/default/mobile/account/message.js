...
import { MessageColumnComponent } from "../../../../../views/theme/default/mobile/column"
...
export default class App extends Component {
    constructor(props) {
        super(props)
        const { columns, request_query, logged_in_user,
        ...
        return (
            <div className="app">
                ...
                <div className="client">
                    <MessageColumnComponent {...this.props} column={this.column} />
                </div>
                <EmojiPicker />
            </div>
        )

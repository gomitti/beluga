...
export default class App extends AppComponent {
    constructor(props) {
        ...
        this.statuses_for_features = []
        if (props.statuses.length > 4) {
            this.statuses_for_features = [
                props.statuses[0],
                props.statuses[1],
                props.statuses[2],
            ...
            <div>
                ...
                <div className="welcome-component">
                    <div className="left-area">
                        ...
                        <p>旧Belugaユーザーの人はアカウントを作り直してください</p>

                        <div className="features-component">
                            <div className="header">
                                <h1>Belugaの特徴</h1>
                                <h2>他のSNSにはない新しい機能を使ってみてください！</h2>
                            </div>
                            <div className="features-grid">
                                <div className="row">
                                    <div className="feature">
                                        <h1 className="title">いいね</h1>
                                        <div className="status-area">
                                            <StatusComponent status={this.statuses_for_features[0]}
                                                key={this.statuses_for_features[0].id}
                                                options={options}
                                                handle_click_channel={do_nothing}
                                                handle_click_mention={do_nothing}
                                                handle_click_thread={do_nothing}

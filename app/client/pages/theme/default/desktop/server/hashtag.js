...
class MultipleColumnsContainer extends MultipleColumnsContainerView {
    constructor(props) {
        super(props)
        const { server, logged_in, columns, hashtag, callback_change } = props
...
export default class App extends Component {
    ...
    render() {
        const { hashtag, server, logged_in, platform, pinned_emoji_shortnames, custom_emoji_shortnames, statuses } = this.props
        return (
            <div id="app" className={classnames("timeline hashtag", {
